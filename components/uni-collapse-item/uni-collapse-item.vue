<template>
	<view :class="['uni-collapse-cell', { 'uni-collapse-cell--disabled': disabled, 'uni-collapse-cell--open': isOpen }]"
	 :hover-class="disabled ? '' : 'uni-collapse-cell--hover'">
		<view class="uni-collapse-cell__title header cu-bar bg-white" style="height: 80upx;min-height: 80upx;" @click="onClick">
			<view v-if="thumb" class="uni-collapse-cell__title-extra">
				<image :src="thumb" class="uni-collapse-cell__title-img" />
			</view>
			
			<view class="uni-collapse-cell__title-inner action" style="display: flex;flex-direction: row;justify-content: flex-start;margin: auto 0upx;">
				<text class="cuIcon-title text-blue" style="color:#3A82CC"></text>
				<view class="uni-collapse-cell__title-text" style="font-size: 28upx;color:#3A82CC">{{ title }}</view>
			</view>
			<!-- <view class="cu-bar solid-bottom bg-white" style="min-height: 80upx;">
				<view class="action" style="font-size: 28upx;min-height: 80upx;">
					<text class="cuIcon-title text-blue" style="color:#3A82CC"></text>
					<text style="font-size: 28upx;color:#3A82CC">{{ title }}</text>
				</view>
			</view> -->
